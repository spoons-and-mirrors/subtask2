...
This plugins affects how opencode handles slash commands with additional frontmatter parameters and enables parallel command execution. Basically, super powers for your slash commands
